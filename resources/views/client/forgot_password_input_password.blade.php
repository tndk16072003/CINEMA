            ...
            <div class="col-xl-8 col-lg-7">
                <div class="contact-form-wrap">
                    ...
                    <div class="contact-form">
                        <form action="/forgot-password/input-password" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" value="{{ $hash }}" name="hash_reset">
                                </div>
                                <div class="col-md-12">
                                    <input id="password" type="password" name="password" placeholder="Enter new password *">
                                </div>
                                <div class="col-md-12">
                                    <input id="re_password" type="password" name="re_password" placeholder="Enter new password again *">
                                </div>
                            </div>
