...
@section('content')
    <section id="app" class="movie-area movie-bg" data-background="/assets_client/img/bg/movie_bg.jpg">
        <div class="container">
                        ...
                        <div class="movie-item movie-item-three mb-50">
                            <div class="movie-poster">
                                ...
                                <ul class="overlay-btn">
                                    ...
                                    <li><a v-bind:href="{{ $value->trailer }}" class="popup-video btn">Watch Now</a></li>
