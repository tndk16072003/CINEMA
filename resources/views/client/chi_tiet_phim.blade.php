                ...
                <div class="row align-items-center position-relative">
                    <div class="col-xl-3 col-lg-4">
                        <div class="movie-details-img">
                            ...
                            <a href="{{ $phim->trailer }}" class="popup-video"><img
                        ...
                        <div class="movie-details-content">
                            ...
                            <div class="banner-meta">
                                <ul>
                                    <li class="quality">
                                        @if ($phim->lua_tuoi == 0)
                                            <span>5+</span>
                                        @elseif ($phim->lua_tuoi == 1)
                                            <span>12+</span>
                                        @elseif ($phim->lua_tuoi == 2)
                                            <span>16+</span>
                                        @else
                                            <span>18+</span>
                                        @endif
                                        @if ($phim->chat_luong == 0)
                                            <span>2D</span>
                                        @elseif ($phim->chat_luong == 1)
                                            <span>3D</span>
                                        @else
                                            <span>4K</span>
                                        @endif
                            ...
                            <div class="mt-3">
                                @foreach ($lich_chieu as $key => $value)
                                    <a href="/client/dat-ve/{{ $value->id }}"
                                        class="m-2 banner-btn btn wow fadeInUp">{{ $value->thoi_gian_bat_dau }}</a>
                                @endforeach
                            </div>
                            <div class="movie-details-prime">
                                <ul>
                                    ...
                                    <li class="watch"><a href="{{ $phim->trailer }}" class="btn popup-video"><i
                    ...
                    <div class="movie-details-btn">
                        <a target="_blank" href="{{ $phim->avatar }}" class="download-btn" download="">Download <img
