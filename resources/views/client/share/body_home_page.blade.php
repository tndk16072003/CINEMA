...
<section class="ucm-area ucm-bg2" data-background="/assets_client/img/bg/ucm_bg02.jpg">
    <div class="container">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="dangChieu" role="tabpanel" aria-labelledby="dangChieu-tab">
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 order-0 order-lg-2">
                <div class="services-img-wrap">
                    ...
                    <a href="/assets_client/img/images/services_img02.jpg" class="download-btn" download>Download <img src="/assets_client/fonts/download.svg" alt=""></a>
                </div>
            </div>
